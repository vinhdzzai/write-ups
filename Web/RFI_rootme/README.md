...
- ta thấy respone null byte đã cắt hậu tố nhưng không thể thực thi , có lẽ đã index.php không resolve path giống với file được include, hoặc null byte thực sự không hoạt động hoặc something gets wrong?
